...
# === Load model ===
model = joblib.load(r"C:\Users\Narmadha R\OneDrive\Desktop\python\forecasting_ev_model (1).pkl")
...
# Image
st.image(r"C:\Users\Narmadha R\OneDrive\Desktop\python\ev-car-factory.jpg", use_container_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\Narmadha R\OneDrive\Desktop\python\preprocessed_ev_data (1).csv")
